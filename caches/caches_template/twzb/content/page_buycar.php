							...
							<div class="review_form">
								...
								<div class="select_box" >
									<div class="select_name">品牌：
										...
										<select class="pc-select-brand" name="brand-1" id="brand-1" width="100" style="width: 120px;">
										...
										<select class="pc-select-brand" name="brand-2" id="brand-2" width="100" style="width: 120px;">
											<option value="">请选择菜单</option>
										</select>
										<script type="text/javascript">
                                            $(function(){
                                                var $ld5 = $(".pc-select-brand");
                                                $ld5.ld({ajaxOptions : {"url" : "<?php echo APP_PATH;?>api.php?op=get_linkage&act=ajax_select&keyid=3360"},defaultParentId : 0,style : {"width" : 120}})
								...
								<div class="select_box">
									...
									<div class="select_area" style="width:500px;">
								...
								<div class="select_box two_select">
									<div class="select_name">上牌城市：
										<td><input type="hidden" name="info[city]" id="city" value="">
											<select class="pc-select-city" name="city-1" id="city-1" width="100" style="width: 120px;">
												<option value="">请选择菜单</option>
...
<script type="text/javascript" src="js/product_wantbuy-9650.js"></script>
