	...
	<?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
    	<div class="col-auto">
        	<div class="col-1 member-info">
            	<div class="content">
                  ...
                  <div class="col-auto">
					...
					$citypro=$this->_get_linkage_fullname($memberinfo[pro],$linkagelist);
					
					
		
					?>
					 
					  所在城市：<?php echo $citypro;?>， 联系电话：<a href="index.php?m=member&c=index&a=account_change_mobile&t=1"><?php echo $memberinfo['mobile'];?></a>
			...
			<div class="col-1 ">
            	...
            	<div class="content">
					<p class="xinxi">昵称：<?php echo $memberinfo['nickname'];?></p>  
					<p class="xinxi">所在城市：<?php echo $citypro;?> </p>
					<p class="xinxi">联系电话：<a href="index.php?m=member&c=index&a=account_change_mobile&t=1"><?php echo $memberinfo['mobile'];?></a></p>  
					<p class="xinxi">所在公司：<?php echo $memberinfo['gongsi'];?></p> 
					<p class="xinxi">所属职业：<?php echo $memberinfo['zhiye'];?> </p>   
					<p class="xinxi">关注信息：<?php echo $memberinfo['guanzhu'];?></p>
...
.content .xinxi{float:left;width:300px;margin-top:20px;}
</style>