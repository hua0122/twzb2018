...
#content{width:1200px; margin:auto; padding:36px 0 0 0}
.form-login{ width:440px; padding-left:0px;border: 1px #E7E8E7 solid;padding-top:50px;padding-bottom:50px;margin-top:30px;}
.form-login h2{font-size:25px;color:#494949;border-bottom: 1px dashed #CCC;padding-bottom:3px; margin-bottom:10px}
.form-login .input{ padding:15px 0;padding-left:15%;}
.form-login .take{padding-left:30%;}
...
<div class="col-auto col-left">
	<img src="<?php echo APP_PATH;?>images/login_left.jpg" width="600"/>		
...
<input type="hidden" name="forward" id="forward" value="<?php echo $forward;?>">
		...
		<a href="<?php echo APP_PATH;?>index.php?m=member&c=index&a=register&siteid=<?php echo $siteid;?>" style="margin-left:20px;">免费注册</a>
		<a href="index.php?m=member&c=index&a=public_get_password_type&siteid=<?php echo $siteid;?>" style="margin-left:60px;">忘记密码</a><br />
		<div class="submit"><input type="submit" name="dosubmit" id="dosubmit" value="立即登录"></div></div>
