...
/*Language Format:
Add a new file(.lang.php) with your module name at /NTCMS/languages/
translation save at the array:$LANG
*/

//index
$LANG['admin_site_title'] = 'NTCMS - 后台管理中心';
$LANG['expand_or_contract'] = '展开与收缩';
$LANG['NTCMS_title'] = 'NTCMS内容管理系统';
...
$LANG['main_safety_permissions'] = '※ 建议您将NTCMS目录设置为755（linux）或只读（windows），<a href="http://www.phpip.com/html/2014/changjianwenti_0430/133.html" target="_blank">点击查看教程</a>';
...
$LANG['main_product_team'] = 'NTCMS系统开发团队';
...
<B>互联网新闻开放协议：</B> <br>
1、互联网新闻开放协议》是百度新闻搜索制定的搜索引擎新闻源收录标准，网站可将发布的新闻内容制作成遵循此开放协议的XML格式的网页（独立于原有的新闻发布形式）供搜索引擎索引。 NTCMS可自动生成网站的Sitemaps，但是您还需要向google或者baidu提交Sitemaps的访问地址。<br>
您的网站的Sitemaps 访问地址为：<?=APP_PATH?>sitemaps.xml<br>
NTCMS可自动生成网站的<<互联网新闻开放协议>>，但是您还需要向baidu提交访问地址。<br>
...
$LANG['domain_name_format'] = '域名可为空，格式应该为http://www.NTCMS.cn/';
$LANG['domain_end_string'] = '格式应该为http://www.NTCMS.cn/，请以‘/’结束';
...
$LANG['site_domain_ex'] = '请填写域名，格式为：http://www.NTCMS.cn/';
$LANG['site_domain_ex2'] = '格式应该为http://www.NTCMS.cn/，请以‘/’结束';
