...
<div class="header">
    ...
    <div class="rt-col">
    	<div class="tab_style white cut_line text-r"><a href="javascript:;" onclick="lock_screen()"><img src="<?php echo IMG_PATH.'icon/lockscreen.png'?>"> <?php echo L('lockscreen')?></a><span>|</span><a href="http://www.newteng.net" target="_blank">NTCMS</a><span>|</span><a href="http://www.newteng.net" target="_blank"><?php echo L('authorization')?></a><span>|</span><a href="http://www.newteng.net" target="_blank"><?php echo L('igenus_for_postfix')?></a><span>|</span><a href="http://www.newteng.net" target="_blank"><?php echo L('help')?></a>
    <ul id="Skin">
