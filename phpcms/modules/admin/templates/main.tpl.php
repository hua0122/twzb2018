...
<?php if($pc_writeable) {?>	
※ 建议您将NTCMS目录设置为755（linux）或只读（windows）<br />
...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?>Ntcms <?php echo PC_VERSION?>  Release <?php echo PC_RELEASE?> <br />
...
<div class="col-2 lf mr10" style="width:48%">
	...
	<div class="content">
	<?php echo L('main_copyright')?>重庆纽腾网络有限公司<br />
	<?php echo L('main_product_dev')?>纽腾网络团队<br />
	<?php echo L('main_product_ui')?>纽腾UI设计团队<br />
	<?php echo L('main_product_site')?><a href="http://www.newteng.net/" target="_blank">http://www.newteng.net/</a> <br />
	<?php echo L('main_product_bbs')?><a href="http://www.newteng.net/" target="_blank">http://www.newteng.net/</a> <br />
	邮箱：cqntwl@foxmail.com <br />
	咨询电话：023-63001336
	</div>
</div>
...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?>NTcms <?php echo PC_VERSION?>  Release <?php echo PC_RELEASE?> [<a href="http://www.newteng.net/" target="_blank"><?php echo L('main_support')?></a>]<br />
