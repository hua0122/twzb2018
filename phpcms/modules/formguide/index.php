...
class index {
	...
	public function show() {
		...
		if (isset($_POST['dosubmit'])) {
			...
			if (isMobile()){ 
				showM('操作成功',APP_PATH.'index.php?m=member');
				
			}else{
				showmessage("感谢您宝贵的意见，我们会尽快回复您！", APP_PATH.'index.php?m=member&c=index&a=tousu');
			}
    ...
    public function show1() {
        ...
        if (isset($_POST['dosubmit'])) {
            ...
            if (isMobile()){
                showM('信息已提交，我们会尽快联系您！',APP_PATH);

            }else{
                showmessage("信息已提交，我们会尽快联系您！", APP_PATH);
            }
