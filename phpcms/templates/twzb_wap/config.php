<?php return array (
  ...
  'author' => 'NTCMS TEAM',
  'dirname' => 'twzb_wap',
  'homepage' => 'http://www.newteng.net/',
  'version' => '1.0',
  'disable' => 0,
  'file_explan' => 
  array (
    'templates|twzb_wap|content' => 
    array (
      'category.html' => '文章频道页',
    ...
    'templates|twzb_wap|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|twzb_wap|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|twzb_wap|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|twzb_wap|wap' => 
    array (
    ...
    'templates|twzb_wap|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|twzb_wap|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|twzb_wap|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|twzb_wap|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|twzb_wap|yp' => 
    array (
      'com_default' => '企业默认模板',
      'index.html' => '黄页首页模板',
      'list.html' => '列表页模板',
    ...
    'templates|twzb_wap|yp|com_default' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|twzb_wap|comment' => 
    array (
