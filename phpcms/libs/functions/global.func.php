 ...
 */
 ...
 function isMobile(){   
	...
	$mobile_os_list=array('Google Wireless Transcoder','Windows CE','WindowsCE','Symbian','Android','armv6l','armv5','Mobile','CentOS','mowser','AvantGo',
'Opera Mobi','J2ME/MIDP','Smartphone','Go.Web','Palm','iPAQ');  $mobile_token_list=array('Profile/MIDP','Configuration/CLDC-','160×160','176×
220','240×240','240×320','320×
240','UP.Browser','UP.Link','SymbianOS','PalmOS','PocketPC','SonyEricsson','Nokia','BlackBerry','Vodafone','BenQ','Novarra-Vision','Iris','NetFront','HTC_','Xda_
...
//让array_column()函数兼容低版本PHP  array_column() 返回输入数组中某个单一列的值。
...
<script type="text/javascript" src="phpcms/templates/twzb_wap/js/mdialog.js"></script>
					<div class="mask"></div>
					<div id="animationTipBox" style="width: 250px; height: 206px; margin-left: -125px; margin-top: -103px;">
					<div class="success"> 
					<div class="icon"><div class="line_short"></div>
					<div class="line_long"></div>  </div> 
					<div class="dec_txt">'.$msg.'</div></div>
					<button class="okoButton">ok</button>
					<script>
					$(function(){
